            ...
            <div className='max-w-[1320px] my-0 mx-auto py-0 px-4'>
                <div className='mx-0 text-center px-0 py-5 my-5 md:grid md:grid-cols-2 xl:grid-cols-4'>
                    <div className='my-3 mx-0 p-4'>
                        <span className='block'><i className='flex justify-center'><BiPhoneCall className='text-[#f7327a] text-[4rem] pb-[0.9rem]' /></i></span>
                        <span className='block font-medium text-[1.1rem]'>Phone No.</span>
                        <span className='pt-[0.4rem] block'>0898320059</span>
                    </div>

                    <div className='my-3 mx-0 p-4'>
                        <span className='block'><i className='flex justify-center'><BiEnvelope className='text-[#f7327a] text-[4rem] pb-[0.9rem]' /></i></span>
                        <span className='block font-medium text-[1.1rem]'>Email</span>
                        <span className='pt-[0.4rem] block'>koichamp@gmail.com</span>
                    </div>

                    <div className='my-3 mx-0 p-4'>
                        <span className='block'><i className='flex justify-center'><BiMap className='text-[#f7327a] text-[4rem] pb-[0.9rem]' /></i></span>
                        <span className='block font-medium text-[1.1rem]'>Address</span>
                        <span className='pt-[0.4rem] block'>FPT University</span>
                    </div>

                    <div className='my-3 mx-0 p-4'>
                        <span className='block'><i className='flex justify-center'><BsClock className='text-[#f7327a] text-[4rem] pb-[0.9rem]' /></i></span>
                        <span className='block font-medium text-[1.1rem]'>Opening Hours</span>
                        <span className='pt-[0.4rem] block'>Monday - Friday (9:00 AM to 5:00 PM)</span>
                    </div>
                </div>
                ...
                <div className='py-8 pr-0 lg:pl-10 border-t border-solid border-[#c7c7c7] lg:grid lg:grid-cols-2 lg:items-center'>
                    <form action="" className='pb-4'>
                        ...
                        <button type="submit" className='text-[1rem] uppercase text-white bg-[#f7327a] border-none rounded py-[0.7rem] px-[1.5rem] cursor-pointer transition-all hover:opacity-80' value="send message">Send Message</button>
                    </form>
